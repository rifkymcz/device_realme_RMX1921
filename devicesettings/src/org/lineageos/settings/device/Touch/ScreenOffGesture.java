...
package org.lineageos.settings.device.KernelControl;
package org.lineageos.settings.device.R;
import package org.lineageos.settings.device.Touch.util.ActionConstants;
import package org.lineageos.settings.device.Touch.util.AppHelper;
import package org.lineageos.settings.device.Touch.util.ShortcutPickerHelper;
import package org.lineageos.settings.device.Touch.util.Utils;
